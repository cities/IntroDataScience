...
This describes a hands-on activity where the goal is to author an R Markdown document and render it to HTML/pdf/docx.

For people also using Git and GitHub, we discuss how to keep the intermediate Markdown file, the figures, and what to commit to Git and push to GitHub.
