...
3. Understand your data by iteratively
  ...
  - tranforming and
  - modeling your data
4. Communicate your results to an audience, or
...
For more R packages for the tidyverse workflow see [RStartHere](https://github.com/rstudio/RStartHere)
...
RStudio organizes work by projects. A RStudio project is a group of files and directories organized for self-contained work. For example, it can be a R package under development, or code, data and documents for a research project, or a book project (for example, Hadley use a RStudio project for the R for Data Science book at https://github.com/hadley/r4ds). 
...
I prefer to organize my files in subdirectories, typically with these items:
